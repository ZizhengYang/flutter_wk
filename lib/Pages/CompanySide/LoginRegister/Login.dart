...
//                color: Colors.red,
                      child: new Column(
                          children: <Widget>[
                            ...
                            _buildTextField(this._textController1, "邮箱/帐号", 100, false),
                            new Container(
                                child: new Text(
                                    "请输入您的邮箱或帐号",
                                    style: TextStyle(
                            ...
                            _buildTextField(this._textController2, "密码", 100, true),
                            new Container(
                                child: new Text(
                                    "请输入您的密码",
                                    style: TextStyle(
  ...
  Widget _buildTextField(TextEditingController controller, String text, double width, bool isPassword) {
    return new Center(
        child: new Container(
