...
@RequestMapping(path="/Rating_C_to_S") // This means URL's start with /demo (after Application path)
public class Rating_C_to_S_Controller {
	
	// This means to get the bean called userRepository
	// Which is auto-generated by Spring, we will use it to handle the data
	@Autowired 
	private Rating_C_to_S_Repository rating_C_to_S_Repository ;
