...
import xiaoqian.repository.taskDetailRepository.Feedback_C_to_U_Repository;

@Controller // This means that this class is a Controller
@RequestMapping(path="/Feedback_C_to_U") // This means URL's start with /demo (after Application path)
public class Feedback_C_to_U_Controller {
	
	// This means to get the bean called userRepository
	// Which is auto-generated by Spring, we will use it to handle the data
	@Autowired 
	private Feedback_C_to_U_Repository feedback_C_to_U_Repository ;
