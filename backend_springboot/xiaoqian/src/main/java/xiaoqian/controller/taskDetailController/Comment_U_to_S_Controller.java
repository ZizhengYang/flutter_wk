...
@RequestMapping(path="/Comment_U_to_S") // This means URL's start with /demo (after Application path)
public class Comment_U_to_S_Controller {
	
	// This means to get the bean called userRepository
	// Which is auto-generated by Spring, we will use it to handle the data
	@Autowired 
	private Comment_U_to_S_Repository comment_U_to_S_Repository ;
